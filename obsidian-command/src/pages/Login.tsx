    ...
    <div className="min-h-screen flex flex-col text-on-surface selection:bg-primary/30 selection:text-primary">
      <header className="fixed top-0 z-50 w-full border-b border-outline/30 bg-background/40 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link to="/" className="font-headline text-xl font-extrabold tracking-tight text-on-surface uppercase">
            SONIX <span className="text-primary">2.0</span>
          </Link>
          <div className="flex items-center gap-6">
            <Link to="/" className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors">
              Home
            </Link>
          </div>
        </div>
