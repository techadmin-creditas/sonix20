                           ...
                           <div className="absolute inset-x-0 bottom-0 h-1/2 bg-linear-to-t from-surface-low to-transparent flex flex-col justify-end p-8 space-y-6 pb-2">
                              ...
                              <div className="relative pt-4 border-t border-outline-variant/20">
                                 ...
                                 <button
                                    ...
                                    disabled={!isComplete}
                                    className="absolute right-0 bottom-6 size-16 rounded-full ember-gradient flex items-center justify-center  shadow-lg hover:scale-110 transition-all z-10 disabled:opacity-50 disabled:cursor-not-allowed"
                                 >
            ...
            <div className="px-10 py-8 bg-surface-lowest border-t border-outline-variant/10 flex items-center justify-between shrink-0">
               ...
               <div className="flex items-center gap-4">
                  <button
                     ...
                     className={cn(
                        "px-10 py-5 rounded-3xl ember-gradient font-black text-[12px] uppercase tracking-[0.3em] flex items-center gap-3 shadow-xl hover:scale-[1.02] transition-all",
      ...
      <div className="space-y-4 relative z-10">
         ...
         <div className="grid grid-cols-2 gap-2">
            <div className="p-2.5 rounded-xl bg-surface-low/50 border border-outline-variant/5">
               <p className="text-[10px] font-bold text-outline uppercase mb-1.5 flex items-center gap-1"><Activity className="size-2.5" /> Urgency</p>
            ...
            <div className="p-2.5 rounded-xl bg-surface-low/50 border border-outline-variant/5">
               <p className="text-[10px] font-bold text-outline uppercase mb-1.5 flex items-center gap-1"><Sparkles className="size-2.5" /> Empathy</p>
               <div className="h-1 w-full bg-surface-low rounded-full overflow-hidden">
               ...
               {debug ? (
                  ...
                  <>
                     ...
                     <button
                        ...
                        className="flex items-center gap-2.5 ember-gradient  px-8 py-3.5 rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-xl shadow-primary/10 hover:scale-105 active:scale-95 transition-all"
                     >
