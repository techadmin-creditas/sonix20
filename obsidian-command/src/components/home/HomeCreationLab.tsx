        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="reveal-item text-4xl lg:text-5xl font-black leading-tight text-on-surface">
              Your Voice Empire, <br/><span className="text-primary">Built in Seconds.</span>
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div 
                ...
                className={`group cursor-pointer overflow-hidden rounded-3xl border transition-all duration-500 hover:scale-[1.02] active:scale-95 relative ${
                  activeStep === i 
              ...
              >
                ...
                <div className="flex items-center gap-5 relative z-10">
                  ...
                  <h4 className={`font-black text-xl lg:text-2xl tracking-tight transition-all duration-500 ${
                    activeStep === i ? 'text-on-surface' : 'text-on-surface-variant group-hover:text-on-surface'
                  }`}>{s.title}</h4>
                </div>
