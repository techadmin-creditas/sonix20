  ...
  return (
    ...
    >
      <div className="text-center mb-8 reveal-item">
        <h2 className="font-headline text-5xl font-black md:text-7xl mb-4 text-on-surface">
          Meet Your <span className="text-primary">Digital Team.</span>
        </h2>
        <p className="mx-auto max-w-2xl text-[13px] md:text-sm text-on-surface-variant font-medium">
