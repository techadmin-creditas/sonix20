...
class GeminiLive:
    ...
    """
    def __init__(self, api_key, model, input_sample_rate, tools=None, tool_mapping=None, voice_name="Puck", system_prompt=None):
        """
        ...
        Args:
            ...
            voice_name (str, optional): Voice name for speech output. Defaults to "Puck".
        ...
        self.system_prompt = system_prompt or "You are a helpful AI assistant. Keep your responses concise."
